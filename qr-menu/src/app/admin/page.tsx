    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F9FAFB] p-4 font-sans text-center">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 max-w-md w-full">
          ...
          <a
            href="/login"
            className="inline-flex w-full justify-center bg-gray-900 text-white px-6 py-3.5 rounded-xl font-bold shadow-md hover:bg-gray-800 transition-all active:scale-[0.98]"
          >
            Return to Login
          </a>
        </div>
